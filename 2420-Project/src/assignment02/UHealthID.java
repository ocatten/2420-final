...
/**
 * This class represents a unique UHealthID, consisting of a 4 letter String and a 4 number integer.
 * 
...
public class UHealthID {
	...
	/**
	 * @Constructor that parses the given string to create a UHealthID.
	 * 
